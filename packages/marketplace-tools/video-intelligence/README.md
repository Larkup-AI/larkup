...
Every runtime requires user-selected audio, agent/tool-brain, and vision
providers, models, and API keys. Saved **AI Models** configuration can prefill
brain and vision. Local mode injects these settings only into the local
...
| Var                                         | Default                               | Purpose                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------- | ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `LARKUP_VIDEO_VISION_PROVIDER`              | `vercel_ai_gateway`                   | `vercel_ai_gateway`, `google`, or `openai`; selected automatically from AI Models unless overridden locally. |
| `LARKUP_VIDEO_VISION_API_KEY`               | unset                                 | Selected provider key; supplied from AI Models or the optional local override. |
...
| `LARKUP_VIDEO_AGENT_PROVIDER`               | `vercel_ai_gateway`                   | `vercel_ai_gateway`, `google`, or `openai`; configures the bounded extraction planner independently of vision. |
