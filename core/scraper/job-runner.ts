import type { CrawlJob, CrawlJobStatus, CrawlTarget } from "@/core/types"
import { getJob, updateJob } from "@/core/jobs-store"
import { addCrawledDocuments, type NewDocumentInput } from "@/core/documents-store"
import {
  cancelCrawl,
  getCrawlStatus,
  scrapePage,
  startCrawl,
} from "@/core/scraper/firecrawl"
