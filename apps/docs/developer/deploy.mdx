...
Generate a portable artifact for Docker, Vercel, or another Node.js host:
...
Start locally or generate the extendable agent target:
...
Run `larkup test --endpoint <url>` after deployment to verify the server health endpoint.
