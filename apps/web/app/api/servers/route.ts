...
import { corpusStats } from "@buddy-rag/core/documents-store"
import { readRun } from "@buddy-rag/core/index-store"
import { readServerState } from "@buddy-rag/core/generator/server-runtime"
...
export async function DELETE(req: Request) {
  ...
  try {
    const { stopServer } = await import("@buddy-rag/core/generator/server-runtime")
