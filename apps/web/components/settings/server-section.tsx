      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm leading-relaxed text-muted-foreground">
            Start the server locally to test your AI endpoints. Your configuration and API keys will
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription className="text-xs">
            ...
            <code className="text-[11px] bg-muted px-1 py-0.5 rounded">Authorization</code> header.
          </CardDescription>
        </CardHeader>
