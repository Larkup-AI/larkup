...
export function ProjectFormDialog({ mode, target, open, onOpenChange }: Props) {
  const { createProject, renameProject } = useProject();
  ...
  async function submit() {
    ...
    try {
      if (mode === 'create') {
        ...
        await renameProject(target.id, trimmed);
