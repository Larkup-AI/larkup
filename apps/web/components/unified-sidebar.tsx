        ...
        >
          {collapsed ? (
            <Tooltip>
              ...
              >
                <div className="relative size-8 rounded-lg border border-border bg-card flex items-center justify-center shadow-sm text-muted-foreground transition-colors group-hover:text-foreground">
