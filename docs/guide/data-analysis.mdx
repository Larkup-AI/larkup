...
<Frame caption="A 500-row Excel file staged for upload with column schema preview">
  <img src="/images/new/upload-excel-data.png" alt="Excel file staged in the Files tab with column types detected" />
</Frame>

Click **Start Indexing** to begin. Progress is shown in real time.

<Frame caption="Indexing progress for a structured data file">
  <img src="/images/new/upload-excel-data-progress.png" alt="Indexing progress for Excel upload" />
</Frame>
...
<Frame caption="A bar chart generated in Chat from a sales dataset">
  <img src="/images/new/chart-in-chat1.png" alt="Bar chart rendered inline in Chat" />
</Frame>

<Frame caption="Chart with a later summary and suggestions">
  <img src="/images/new/chart-in-chat2.png" alt="Detailed chart answer with analysis and later suggestions" />
</Frame>
