...
<Frame caption="A 500-row Excel file staged for upload with column schema preview">
  <img src="/images/add/upload-excel-data.png" alt="Excel file staged in the Files tab with column types detected" />
</Frame>
...
<Frame caption="Chart with a later summary and suggestions">
  <img src="/images/chat/chart-in-chat2.png" alt="Detailed chart answer with analysis and later suggestions" />
</Frame>
