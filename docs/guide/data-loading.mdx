...
<Tabs>
  ...
  <Tab title="Files">
    Drop in PDF, Word, CSV, JSON, Excel, or plain text. Or select **From URL** to load a public file from a direct link, GitHub, or Hugging Face. Larkup turns GitHub and Hugging Face share links into downloadable file URLs automatically, checks every redirect is public, and limits remote files to 50 MB.
