...
<Steps>
  <Step title="Enter your API key">
    ...
    <Frame caption="Choose a provider and save your API key">
      <img src="/images/new/onboard.png" alt="Larkup onboarding screen with AI provider settings" />
    </Frame>
  ...
  <Step title="Go to the Data page and load something">
    ...
    <Tabs>
      <Tab title="Website">
        ...
        <Frame caption="Add content from a website">
          <img src="/images/new/data-website-scraper-off.png" alt="Website source options in the Data page" />
        </Frame>
      </Tab>
      ...
      <Tab title="Integrations">
        ...
        <Frame caption="Choose Notion or another connected data source">
          <img src="/images/new/data-integrations-tab.png" alt="Data integrations including Notion, Google Drive, Slack, and Jira" />
        </Frame>
      </Tab>
      ...
      <Tab title="CSV">
        ...
        <Frame caption="Review structured data before indexing">
          <img src="/images/new/upload-excel-data.png" alt="CSV and Excel preview in the Files tab" />
        </Frame>
      </Tab>
      ...
      <Tab title="PDF">
        ...
        <Frame caption="Add a PDF from the Files tab">
          <img src="/images/new/upload-pdf.png" alt="PDF staged for upload in the Data page" />
        </Frame>
      </Tab>
      ...
      <Tab title="Video">
        ...
        <Frame caption="Review a YouTube video before import">
          <img src="/images/new/upload-video-data-page.png" alt="YouTube video ready to import from the Media tab" />
        </Frame>
      </Tab>
    </Tabs>
    ...
    <Frame caption="Indexing progress for a PDF upload">
      <img src="/images/new/indexing-pdf-progress.png" alt="PDF indexing progress" />
    </Frame>
  </Step>
  ...
  <Step title="Open Chat and start asking">
    ...
    <Frame caption="Chat with sources visible in the side panel">
      <img src="/images/new/chat-sidebar-on.png" alt="Chat page with sources panel open" />
    </Frame>
  </Step>
</Steps>
...
- [Connect an AI agent](/developer/agent-knowledge-base) through the SDK or REST API.
