...
import { refreshServerStatus } from "@/core/generator/server-runtime"
...
import { runWithServer } from "@/core/workspace"
...
async function snapshot() {
  ...
  if (!ready) {
    blockers.push(
      "Build an index (or launch a generated server) before running a demo query.",
    )
  }
